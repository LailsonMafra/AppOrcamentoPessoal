...
function cadastrarDespesa() {
	...
	if(despesa.validarDados()) {
		bd.gravar(despesa)
		//dialog sucesso
		document.getElementById('modal_titulo').innerHTML = 'Sucesso ao cadastrar'
		...
		//dialog erro
		document.getElementById('modal_titulo').innerHTML = 'Campos inválidos'
		document.getElementById('modal_conteudo').innerHTML = 'Verifique se todos os campos foram devidamente preechidos.'
